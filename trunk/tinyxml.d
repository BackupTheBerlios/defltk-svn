...
protected:
	...
	*/
	...
	{    	
    	...
    	if (p !is null && p.length > 0 && ( IsAlpha( p[0], encoding) || p[0] == '_' ))
    	{
	...
	*/
	...
	{   	    
    	if ( ignoreCase )
    	{
			return 0 == std.string.icmp(p, endTag);    		
    	}
    	else
    	{
    		return 0 == std.string.cmp(p, endTag);    		
    	}    	
    }
	...
	static void ConvertUTF32ToUTF8(dchar input, char* output, int*	length )
	{
    	const dchar BYTE_MASK = 0xBF;
    	const dchar BYTE_MARK = 0x80;
    	const dchar FIRST_BYTE_MARK[7] = [ 0x00, 0x00, 0xC0, 0xE0, 0xF0, 0xF8, 0xFC];
...
public:	
	...
	*/
	TiString Value() const { return value.c_str (); }
	...
	/** Changes the	value of the node. Defined as:
		...
		@endverbatim
	*/
	void SetValue(TiString  _value) { value = _value;}
	...
	TiXmlNode* FirstChild( string  value )
	{
    	TiXmlNode* node;
	...
	TiXmlNode* LastChild( string  value )
	{
    	TiXmlNode* node;
	...
	*/	
	...
	/// Convenience	function to get	through	elements.
	TiXmlElement* FirstChildElement( string  value )
	{
    	TiXmlNode* node;
